  ...
  return (
    <article
      className={`${mergeClass(
        'prose dark:prose-invert prose-sm tablet:prose-base tablet:prose-p:text-base prose-headings:!leading-tight tablet:prose-h1:text-3xl prose-h1:text-2xl tablet:prose-li:text-base max-w-none prose-headings:font-semibold prose-strong:font-semibold prose-neutral prose-code:font-mono prose-img:overflow-hidden prose-img:border prose-img:border-border prose-img:bg-surface prose-img:rounded-xl prose-pre:bg-surface prose-pre:text-foreground prose-pre:border prose-pre:border-border prose-pre:font-semibold overflow-hidden text-foreground/80 prose-headings:text-foreground prose-a:text-foreground prose-strong:text-foreground prose-headings:!text-pretty',
        className,
      )}`}
    >
      {children}
